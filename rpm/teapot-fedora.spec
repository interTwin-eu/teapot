...
Requires:       java-17-openjdk openssl >= 1:3.0 python(abi) = 3.12 python3-fastapi python3-httpx python3-pydantic python3-uvicorn python3-anyio python3-psutil
...
%changelog
* Wed Apr 16 2025 Dijana Vrbanec <dijana.vrbanec@desy.de>
- %{version}
