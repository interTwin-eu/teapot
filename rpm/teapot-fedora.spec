...
cp %{_builddir}/%{_exec_prefix}/local/lib64/python3.12/site-packages/* %{buildroot}/%{_exec_prefix}/local/lib64/python3.12/site-packages/*
mkdir -p %{buildroot}/%{_exec_prefix}/local/lib/python3.12/site-packages/
cp %{_builddir}/%{_exec_prefix}/local/lib/python3.12/site-packages/* %{buildroot}/%{_exec_prefix}/local/lib/python3.12/site-packages/*
