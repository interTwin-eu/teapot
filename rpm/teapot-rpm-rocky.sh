...
cd /tmp
curl -O https://syncandshare.desy.de/index.php/s/YaAxAH4odzMyrHY/download/python-lib64-rocky.tar.gz .
curl -O https://syncandshare.desy.de/index.php/s/ddfGKitf9SJ4Yb4/download/python-lib-rocky.tar.gz .
